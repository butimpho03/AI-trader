...
class GeminiAIProvider(AIProvider):
    ...
    def quick_scan_chart(
        ...
        text, failure = self._call_gemini_vision(prompt, image_bytes, max_output_tokens=1500)
        if failure:
    ...
    def _parse_json_with_repair(self, text: str, schema_keys: str) -> Optional[dict]:
        ...
        repaired_text, failure = self._call_gemini_vision(repair_prompt, image_bytes=None, max_output_tokens=1500)
